        ...
        appBar: AppBar(
          ...
          actions: [
            IconButton(onPressed: (){
              Navigator.push(context, MaterialPageRoute(builder: (context) => const SecondHistoryPage()));
            ...
            Column(
              children: <Widget>[
                ...
                child: ListTile(
                  ...
                  title: Text("Toyota Avanza 1.3 E MT",
                      textAlign: TextAlign.center,
                      style: const TextStyle(fontSize: 16,
                      ), 
                        ),
                  subtitle: Text("P 3821 AA",
                      textAlign: TextAlign.left,
                      style: TextStyle(fontSize: 16),
                  ),
                  trailing: Text("1 hari\nRp 100.000",
                      textAlign: TextAlign.right,
                      style: const TextStyle(fontSize: 16),
                      ),
                ),
              ...
              Card(
                ...
                child: ListTile(
                  ...
                  title: Text("Mercedes Benz CL Class 500",
                      textAlign: TextAlign.center,
                      style: const TextStyle(fontSize: 16,
                      ), 
                        ),
                  subtitle: Text("N 9742 FD",
                      textAlign: TextAlign.left,
                      style: TextStyle(fontSize: 16),
                  ),
              ...
              Card(
                ...
                child: ListTile(
                  ...
                  title: Text("Honda Jazz RS CVT",
                      textAlign: TextAlign.center,
                      style: const TextStyle(fontSize: 16,
                      ), 
                        ),
                  subtitle: Text("W 5433 YY",
                      textAlign: TextAlign.left,
                      style: TextStyle(fontSize: 16),
                  ),
                  trailing: Text("3 hari\nRp 440.000",
